/*
Template Name: FOMS ACADEMY Business Management System - Bootstrap 5 Admin & Dashboard Template
...
(function($) {
    ...
    var language = localStorage.getItem('FOMSBMS-language');
    // Default Language
    var default_lang = 'en';
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            ...
            localStorage.setItem('FOMSBMS-language', lang);
            language = localStorage.getItem('FOMSBMS-language');
            getLanguage();
        }
    }
