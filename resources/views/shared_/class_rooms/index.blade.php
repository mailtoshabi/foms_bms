...
<a href="{{ route($routePrefix.'.class_rooms.create') }}"
...
<a href="{{ route($routePrefix.'.class_rooms.index') }}"
class="btn btn-light">
Reset
</a>
...
<a href="{{ route($routePrefix.'.class_rooms.edit',encrypt($c->id)) }}">
<i class="mdi mdi-pencil text-success"></i>
</a>

<a href="{{ route($routePrefix.'.class_rooms.changeStatus',encrypt($c->id)) }}">
...
method="POST"
action="{{ route($routePrefix.'.class_rooms.destroy',encrypt($c->id)) }}">
