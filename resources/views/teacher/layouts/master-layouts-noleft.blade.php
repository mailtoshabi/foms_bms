...
<div id="layout-wrapper">
    ...
    <body data-layout="horizontal">
        ...
        @include('teacher.layouts.horizontal')
        <!-- ============================================================== -->
...
<!-- Right Sidebars -->
@include('teacher.layouts.right-sidebar-messages')
@include('teacher.layouts.right-sidebar-sessions')
...
@include('teacher.layouts.vendor-scripts')
</body>
