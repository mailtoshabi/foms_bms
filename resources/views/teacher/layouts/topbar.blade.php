    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('teacher.dashboard') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="24"> <span class="logo-txt">FOMS ACADEMY Business Management System</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="@if ((Auth::guard('teacher')->user()->photo == '') || (empty(Auth::guard('teacher')->user()->photo))) https://ui-avatars.com/api/?name={{ Auth::guard('teacher')->user()->name }}&size=200 @else {{ URL::asset('images/'. Auth::guard('teacher')->user()->photo) }} @endif" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ Auth::guard('teacher')->user()->name }}</span>
