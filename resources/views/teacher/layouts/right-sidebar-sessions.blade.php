...
<div class="right-bar" id="sessions-sidebar">
    <div data-simplebar class="h-100">
        ...
        <div class="p-3">
            <h6 class="fw-bold text-uppercase font-size-12 mb-3">Your Classes</h6>
            @if(isset($teacherClassHours) && $teacherClassHours->count() > 0)
                @foreach($teacherClassHours as $hour)
                    <div class="border rounded p-3 mb-2">
                        ...
                        @if($hour->google_meet_link)
                            <a href="{{ $hour->google_meet_link }}" target="_blank" class="btn btn-sm btn-success w-100 mt-2">
            ...
            @else
                <div class="text-center py-4">
                    ...
                    <p class="text-muted mt-2 font-size-12">No pending sessions found.</p>
                </div>
            @endif
        </div>
    </div>
