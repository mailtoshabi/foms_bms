...
@section('css')
    <style>
        /* Premium Modern Styles for Teacher Login */
        ...
        /* Active theme colors on focus for Teacher Portal */
        ...
        .bg-bubbles li:nth-child(1) {
            ...
            height: 90px;
            animation-delay: 0s;
            background: radial-gradient(circle, rgba(16, 185, 129, 0.18) 0%, rgba(16, 185, 129, 0.02) 100%);
        }
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="portal-title mb-0">Teacher Portal</h5>
                                        <p class="portal-subtitle text-muted mt-2">Sign in to access your teaching dashboard.</p>
                                    </div>
                                            ...
                                            <div class="carousel-item active">
                                                <div class="testi-contain text-center text-white">
                                                    ...
                                                    <div class="mt-4 pt-1">
                                                        ...
                                                        <p class="mb-0 text-white-50 small mt-1">Teaching & Classroom Management Portal</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
