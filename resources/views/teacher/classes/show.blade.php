    ...
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between">
            ...
            @if (!$class->is_completed)
                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#startClassModal">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($hour->google_meet_link && $hour->status == 'pending')
                                        <a href="{{ route('teacher.class-hours.join', encrypt($hour->id)) }}"
                                    ...
                                    {{-- Edit Button --}}
                                    @if($hour->status == 'pending')
                                        <button class="btn btn-sm btn-warning editClassHour" data-id="{{ $hour->id }}"
                                    ...
                                    @if($hour->status == 'pending')
                                        ...
                                        <button class="btn btn-sm btn-success openAttendanceModal" data-id="{{ $hour->id }}">
                ...
                <form method="POST" action="{{ route('teacher.classes.start') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" name="google_meet_link" class="form-control" required>
