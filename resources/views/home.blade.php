...
<body>
    ...
    <div class="container">
        <div class="logo-icon"><img src="{{ asset('images/logo.png') }}" alt="FOMS Academy"></div>
        <h1>FOMS Academy</h1>
        ...
        <p class="footer">&copy; {{ date('Y') }} FOMS Academy. All rights reserved. Crafted by <a
                href="https://webmahal.com" target="_blank" rel="noopener">Web Mahal</a></p>
    </div>
</body>
<script>
    (function () {
