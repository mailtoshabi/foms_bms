    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="@if ((Auth::guard('student')->user()->photo == '') || (empty(Auth::guard('student')->user()->photo))) https://ui-avatars.com/api/?name={{ Auth::guard('student')->user()->name }}&size=200 @else {{ URL::asset('images/'. Auth::guard('student')->user()->photo) }} @endif" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ Auth::guard('student')->user()->name }}</span>
