...
<div class="right-bar" id="messages-sidebar">
    <div data-simplebar class="h-100">
        ...
        <div class="p-3">
            ...
            <div class="message-list">
                @forelse($studentMessages->take(4) as $msg)
            ...
            @if(isset($studentMessages) && $studentMessages->count() > 0)
                <div class="text-center mt-2">
                    <a href="{{ route('student.messages.index') }}" class="btn btn-sm btn-link font-size-12">View All
                        Messages</a>
                </div>
            @endif
        </div>
