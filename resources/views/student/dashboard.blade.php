                ...
                <div class="modal-content shadow-lg border-0" style="border-radius: 16px; overflow: hidden;">
                    ...
                    <div class="modal-body p-4 text-center">
                        <div class="mb-4">
                            ...
                            <a href="{{ asset('assets/payments/upi_qr_code.jpeg') }}" download="upi_qr_code.jpeg"
                        ...
                        <div class="text-start">
                            <h6 class="fw-bold text-dark mb-3"><i class="fas fa-university me-2 text-success"></i>Bank
                                Account Details</h6>
                            ...
                            @if($pendingClassHours->count() > 0)
                                ...
                                <div class="bg-light p-3 rounded-12 mb-3">
                                    ...
                                    <p class="mb-0 text-muted small"><i class="far fa-clock me-1"></i>
                                        {{ $nextSession->created_at->format('d M Y, h:i A') }}
                                    </p>
                                </div>
                            @else
                ...
                <div class="card dashboard-card h-100">
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        ...
                        <div>
                            @if($teacher)
                                <div class="d-flex gap-2">
                                    <button class="btn btn-primary text-white rounded-pill py-2 px-3 fw-semibold flex-grow-1"
                        ...
                        <div>
                            @if($allMessages->count() > 0)
                                <a href="{{ route('student.messages.index') }}"
                                    class="btn btn-outline-primary rounded-pill py-2 px-3 fw-semibold w-100">
            ...
            <div class="col-md-6">
                <div class="card dashboard-card h-100">
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        ...
                        <div class="mt-3">
                            <div class="d-flex gap-2">
                                <button class="btn btn-sm btn-success text-white rounded-pill py-2 fw-semibold w-50"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="m-0">Fee Ledger Detailss</h5>
