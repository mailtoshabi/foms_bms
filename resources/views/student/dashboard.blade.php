...
@section('content')
    <div class="student-dashboard container-fluid px-0">
        ...
        {{-- FEE OUTSTANDING ALERT --}}
        @if($feeDue > 0)
            <div class="row mb-4">
                <div class="col-12">
                    <div class="card border-0 shadow-sm cursor-pointer"
                        style="border-left: 4px solid #ef4444 !important; background-color: #fef2f2; border-radius: 12px;"
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="bg-danger bg-opacity-10 text-danger rounded-circle p-2 d-flex align-items-center justify-content-center"
                                        style="width: 40px; height: 40px; background-color: rgba(239, 68, 68, 0.15);">
                                        <i class="fas fa-exclamation-circle text-danger" style="font-size: 1.2rem;"></i>
                                    </div>
                                    <div>
                                        <h6 class="fw-bold mb-1 text-danger">Fee Outstanding Alert</h6>
                                        <div class="text-muted small">
                                            You have an outstanding fee of <strong
                                                class="text-danger">₹{{ number_format($feeDue, 2) }}</strong>. Please clear your
                                            dues.
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex gap-2">
                                    <button class="btn btn-sm btn-success py-1 px-3 rounded-pill" data-bs-toggle="modal"
                                        data-bs-target="#payNowModal">
                                        <i class="fas fa-credit-card me-1"></i> Pay Now
                                    </button>
                                    <button class="btn btn-sm btn-danger py-1 px-3 rounded-pill" data-bs-toggle="modal"
                                        data-bs-target="#feeDetailsModal">
                                        <i class="fas fa-receipt me-1"></i> View Ledger
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content shadow-lg border-0" style="border-radius: 16px; overflow: hidden;">
                                <div class="modal-header bg-success text-white border-0 py-3">
                                    <h5 class="modal-title fw-bold text-white" id="payNowModalLabel">
                                ...
                                <div class="modal-body p-4 text-center">
                                    <div class="mb-4">
                                        <h6 class="fw-bold text-muted text-uppercase mb-2">Scan & Pay via UPI</h6>
                                        <img src="{{ asset('assets/payments/upi_qr_code.jpeg') }}" alt="UPI QR Code"
                                            class="img-fluid border rounded shadow-sm d-block mx-auto mb-2"
                                            style="max-width: 250px; height: auto;">
                                        <a href="{{ asset('assets/payments/upi_qr_code.jpeg') }}"
                                            download="upi_qr_code.jpeg"
                                            class="btn btn-sm btn-outline-success mt-2 rounded-pill px-3">
                                    ...
                                    <div class="text-start">
                                        <h6 class="fw-bold text-dark mb-3"><i
                                                class="fas fa-university me-2 text-success"></i>Bank
                                            Account Details</h6>
                                        <div class="table-responsive">
                                            <table class="table table-sm table-borderless mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-semibold text-muted py-1" style="width: 35%;">Bank
                                                            Name:</td>
                                                        <td class="fw-bold text-dark py-1">South Indian Bank</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-semibold text-muted py-1">Account Name:</td>
                                                        <td class="fw-bold text-dark py-1">FOMS ACADEMY</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-semibold text-muted py-1">Account No:</td>
                                                        <td class="fw-bold text-success py-1">0476073000000794</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-semibold text-muted py-1">IFSC Code:</td>
                                                        <td class="fw-bold text-dark py-1">SIBL0000476</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-semibold text-muted py-1">Branch Name:</td>
                                                        <td class="fw-bold text-dark py-1">KONDOTTY</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    @foreach($holidays as $holiday)
                                        <div class="mb-4 pb-3 {{ !$loop->last ? 'border-bottom border-light' : '' }}">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <span
                                                    class="badge bg-soft-info text-info font-size-12 px-2.5 py-1.5 rounded-pill"
                                    ...
                                    <div>
                                        ...
                                        @if($pendingClassHours->count() > 0)
                                            ...
                                            <div class="bg-light p-3 rounded-12 mb-3">
                                                <h6 class="mb-1 fw-bold text-dark">{{ $nextSession->classRoom->name ?? '-' }}
                                                </h6>
                                                <p class="mb-0 text-muted small"><i class="far fa-clock me-1"></i>
                                                    {{ $nextSession->created_at->format('d M Y, h:i A') }}</p>
                                            </div>
                                        @else
                                            <p class="text-muted small mb-3">There are no upcoming live class sessions
                                                scheduled.</p>
                                        @endif
                                    </div>
                                    <div>
                                        @if($pendingClassHours->count() > 0)
                                            <div class="d-flex gap-2">
                                                @if($nextSession->google_meet_link)
                                                    ...
                                                    @else
                                                        <button
                                                            class="btn btn-light rounded-pill py-2 px-3 fw-bold flex-grow-1 text-muted"
                                                            disabled title="Wait for teacher to update the class link.">
                                                            <i class="fas fa-video me-1"></i> Join (Wait for Link)
                                                        </button>
                                                    @endif
                                                @endif
                                                @if($pendingClassHours->count() > 1)
                                                    <button class="btn btn-outline-secondary rounded-pill py-2 px-3"
                                                        data-bs-toggle="modal" data-bs-target="#allPendingSessionsModal"
                                                        title="All Pending Sessions">
                            ...
                            <div class="card dashboard-card h-100">
                                <div class="card-body p-4 d-flex flex-column justify-content-between">
                                    <div>
                                        ...
                                        @else
                                            <p class="text-muted small mb-3">No classroom is currently assigned to your account.
                                            </p>
                                        @endif
                                    </div>
                                    <div>
                                        @if($currentClass)
                                            <div class="d-flex gap-2">
                                                ...
                                                @if($student->class_rooms->count() > 1)
                                                    <button class="btn btn-outline-secondary rounded-pill py-2 px-3"
                                                        data-bs-toggle="modal" data-bs-target="#allClassesModal"
                                                        title="All Classes">
                                                        <i class="fas fa-list"></i>
                                                    </button>
                                                @endif
                                    ...
                                    <div>
                                        ...
                                        @if($teacher)
                                            <div class="bg-light p-3 rounded-12 mb-3">
                                                ...
                                                <p class="mb-0 text-muted small"><i class="fas fa-chalkboard-teacher me-1"></i>
                                                    Assigned
                                                    Instructor</p>
                                            </div>
                                        @else
                                        ...
                                        @if($teacher)
                                            <div class="d-flex gap-2">
                                                ...
                                                @if($allTeachers->count() > 1)
                                                    <button class="btn btn-outline-secondary rounded-pill py-2 px-3"
                                                        data-bs-toggle="modal" data-bs-target="#allTeachersModal"
                                                        title="All Teachers">
                                    ...
                                    <div>
                                        ...
                                        @if($allMessages->count() > 0)
                                            ...
                                            <div class="border-start border-primary border-4 ps-3 py-1 mb-3">
                                                <p class="text-dark mb-1 font-italic">
                                                    "{{ Str::limit($latestMsg->message, 80) }}"</p>
                                    ...
                                    <div>
                                        ...
                                        @if($latestNotes->count() > 0)
                                            <div class="border-start border-info border-4 ps-3 py-1 mb-3">
                                                <h6 class="text-dark fw-bold mb-1">{{ ucfirst($latestNotes->first()->title) }}
                                                </h6>
                        ...
                        <div class="col-md-6">
                            <div class="card dashboard-card h-100">
                                <div class="card-body p-4 d-flex flex-column justify-content-between">
                                    <div>
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h6 class="text-uppercase text-muted fw-bold mb-0 small tracking-wider">Overall
                                                Attendance
                                            </h6>
                                        ...
                                        <div class="progress-container cursor-pointer mb-2" data-bs-toggle="modal"
                                            ...
                                            <div class="progress-bar-premium" style="width: {{ $attendancePercent }}%">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <button
                                            class="btn btn-sm btn-light border w-100 text-secondary rounded-pill py-2 fw-semibold"
                                            data-bs-toggle="modal" data-bs-target="#attendanceDetailsModal">
                        ...
                        <div class="col-md-6">
                            <div class="card dashboard-card h-100">
                                <div class="card-body p-4 d-flex flex-column justify-content-between">
                                    <div>
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h6 class="text-uppercase text-muted fw-bold mb-0 small tracking-wider">Fee
                                                Outstanding</h6>
                                            <div
                                                class="icon-wrap {{ $feeDue > 0 ? 'icon-wrap-danger' : 'icon-wrap-success' }} mb-0">
                                    ...
                                    <div class="mt-3">
                                        <div class="d-flex gap-2">
                                            <button
                                                class="btn btn-sm btn-success text-white rounded-pill py-2 fw-semibold w-50"
                                                data-bs-toggle="modal" data-bs-target="#payNowModal">
                                                <i class="fas fa-credit-card me-1"></i> Payment Details
                                            </button>
                                            <button
                                                class="btn btn-sm btn-light border text-secondary rounded-pill py-2 fw-semibold w-50"
                                                data-bs-toggle="modal" data-bs-target="#feeDetailsModal">
                                                <i class="fas fa-receipt me-1"></i> View Ledger
                                            </button>
                                        </div>
                                                ...
                                                @foreach($feeDetails as $fee)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($fee->status == 'paid')
                                                                <span
                                                                    class="badge badge-premium badge-premium-success px-2.5 py-1">Paid</span>
                                                            @elseif($fee->status == 'partial')
                                                                <span
                                                                    class="badge bg-soft-warning text-warning border-warning border rounded-pill px-2.5 py-1">Partial</span>
                                                            @else
                                                                <span
                                                                    class="badge badge-premium badge-premium-danger px-2.5 py-1">Unpaid</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            ...
                                            <tfoot>
                                                <tr class="fw-bold bg-light">
                                                    ...
                                                    <td class="text-success">
                                                        ₹{{ number_format($feeDetails->sum('paid_amount'), 2) }}</td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('student.classes.index') }}"
                                        class="btn btn-primary rounded-pill px-4">View All
                                        Classes</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($msg->sender_type == 'App\\Models\\Student' && $msg->sender_id == $student->id)
                                                                <span
                                                                    class="badge badge-premium badge-premium-primary px-2 py-1">Sent</span>
                                                            @else
                                                                <span
                                                                    class="badge badge-premium badge-premium-success px-2 py-1">Received</span>
                                                            @endif
                                                        </td>
                                                        <td class="fw-bold">
                                                        ...
                                                        <td>
                                                            <div class="text-wrap" style="max-width: 300px;">{{ $msg->message }}
                                                            </div>
                                                        </td>
                                                        <td><small
                                                                class="text-muted">{{ $msg->created_at->format('d M Y, h:i A') }}</small>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('student.messages.index') }}"
                                        class="btn btn-primary rounded-pill px-4">View Full
                                        Inbox</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{ route('student.notes.index') }}"
                                    class="btn btn-primary rounded-pill px-4">Browse All
                                    Materials</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="text-center p-4 rounded-12 border-0"
                                    ...
                                    <small class="text-success d-block fw-bold mb-1 uppercase"
                                        style="letter-spacing: 0.05em; font-size: 0.72rem; text-transform: uppercase;">Your
                                        Attendance
                                        Rate</small>
                                    ...
                                    <p class="text-success text-opacity-75 small mt-2 mb-0 fw-medium">Maintain at least 75%
                                        attendance
