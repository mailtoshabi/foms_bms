    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card text-center">
                <div class="card-body">
                    @if($student->photo)
                        <img src="{{ asset('storage/' . $student->photo) }}" class="rounded-circle mb-2" width="80">
                    @endif
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if($teacher)
                        ...
                        <button class="btn btn-sm btn-success mt-2" data-bs-toggle="modal" data-bs-target="#messageTeacherModal"
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-success" style="cursor:pointer" data-bs-toggle="modal"
                        data-bs-target="#attendanceDetailsModal">{{ $attendancePercent }}%</h3>
                    <div class="progress" style="cursor:pointer" data-bs-toggle="modal"
                    ...
                    {{-- <span class="badge bg-primary" style="cursor:pointer" data-bs-toggle="modal"
                        data-bs-target="#attendanceDetailsModal"><a href="#" class="text-white">View Details</a></span> --}}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <span class="badge bg-primary" style="cursor:pointer" data-bs-toggle="modal"
                        data-bs-target="#feeDetailsModal"><a href="#" class="text-white">View Details</a></span>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if($latestNotes->count() > 0)
                        ...
                        <button class="btn btn-sm btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#allClassNotesModal">
                        ...
                        <div class="list-group">
                            @foreach($allTeachers->take(10) as $t)
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <button class="btn btn-sm btn-success messageTeacherBtn" data-teacher-id="{{ $t->id }}"
