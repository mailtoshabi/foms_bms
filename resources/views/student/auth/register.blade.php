                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="{{ url('/') }}" class="d-block auth-logo">
                                    <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">FOMS ACADEMY Business Management System</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">Register Account</h5>
                                    <p class="text-muted mt-2">Get your free FOMS ACADEMY Business Management System account now.</p>
                                </div>
                                <form class="needs-validation mt-4 pt-2" novalidate method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-0">By registering you agree to the FOMS ACADEMY Business Management System <a href="#" class="text-primary">Terms of Use</a></p>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> FOMS ACADEMY Business Management System   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Web Mahal Web Service</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div id="reviewcarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-indicators auth-carousel carousel-indicators-rounded justify-content-center mb-0">
                                        <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                            <img src="https://ui-avatars.com/api/?name=FA&size=200" class="avatar-md img-fluid rounded-circle d-block" alt="...">
                                        </button>
