...
@section('css')
    <style>
        /* Premium Modern Styles for Student Login */
        ...
        /* Floating form inputs styling (integrating cleanly with Bootstrap) */
        ...
        /* Elegant testimonial container (right side content) */
        .testi-contain {
            position: relative;
            z-index: 5;
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="portal-title mb-0">Student Portal</h5>
                                        <p class="portal-subtitle text-muted mt-2">Sign in to access your learning
                                            dashboard.</p>
                                    </div>
                                            ...
                                            <div class="carousel-item active">
                                                <div class="testi-contain text-center text-white">
                                                    ...
                                                    <h4 class="mt-2 fw-medium lh-base text-white">“From daily updates to big
                                                        insights — manage everything with confidence.”
                                                    </h4>
                                                    <div class="mt-4 pt-1">
                                                        <h5 class="font-size-16 text-white mb-0">FOMS Academy</h5>
                                                        <p class="mb-0 text-white-50 small mt-1">Personalized Learning &
                                                            Management Portal</p>
                                                    </div>
                                                </div>
                                            </div>
