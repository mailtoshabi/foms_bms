                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">Sign in to access your learning dashboard.</p>
                                    </div>
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        Management System<br> Crafted with <i class="mdi mdi-heart text-danger"></i> by <a
                                            target="_blank" href="https://webmahal.com">Web Mahal</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div id="reviewcarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                        {{-- <div
                                            ...
                                            <button type="button" data-bs-target="#reviewcarouselIndicators"
                                                ...
                                                aria-label="Slide 1">
                                                <img src="https://ui-avatars.com/api/?name=FA&size=200"
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div class="testi-contain text-center text-white">
                                                    ...
                                                    <h4 class="mt-4 fw-medium lh-base text-white">“From daily updates to big
