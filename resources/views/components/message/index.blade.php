            ...
            <tbody>
                ...
                @forelse($messages as $message)
                    ...
                    <tr>
                        ...
                        <td>
                            <a
                                href="{{ $showRoute($message->id) }}">{{ $message->sender->name ?? ucfirst($message->sender_type) }}</a><br>
                        ...
                        <td>
                            <a
                                href="{{ $showRoute($message->id) }}">{{ $message->receiver->name ?? ucfirst($message->receiver_type) }}</a><br>
