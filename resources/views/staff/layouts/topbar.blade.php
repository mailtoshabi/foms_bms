            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn d-flex align-items-center gap-2 border-0"
                    ...
                    <img class="rounded-circle header-profile-user"
                        ...
                        alt="Header Avatar">
                    <span
                        class="d-none d-xl-inline-block ms-1 fw-bold text-dark">{{ Auth::guard('staff')->user()->name }}</span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block text-muted"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('staff.dashboard') }}">
                        <i class="mdi mdi-view-dashboard font-size-16 align-middle text-primary"></i>
                        <span>Dashboard</span>
                    </a>
                    <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('staff.profile') }}">
