                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="{{ URL::asset('index') }}" class="d-block auth-logo">
                                        <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="28"> <span
                                            class="logo-txt">FOMS ACADEMY Business Management System</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Confirm Password</h5>
                                        <p class="text-muted mt-2">Re-Password with FOMS ACADEMY Business Management System.
                                        </p>
                                    </div>
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        Management System . Crafted with <i class="mdi mdi-heart text-danger"></i> by Web
                                        Mahal Web Service
                                    </p>
                                </div>
                            </div>
