                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Sign in to continue to FOMS ACADEMY Business Management System.</p>
                                </div>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> FOMS ACADEMY Business Management System<br> Crafted with <i class="mdi mdi-heart text-danger"></i> by <a target="_blank" href="https://webmahal.com">Web Mahal</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="testi-contain text-center text-white">
                                                ...
                                                <h4 class="mt-4 fw-medium lh-base text-white">“From daily updates to big insights — manage everything with confidence.”
                                                </h4>
                                                <div class="mt-4 pt-1 pb-5 mb-5">
                                                    <h5 class="font-size-16 text-white">
                                                    </h5>
