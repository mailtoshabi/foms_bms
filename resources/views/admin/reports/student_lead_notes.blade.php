...
@section('title','Student Lead Notes')
...
<div class="card mb-3">
    <div class="card-body p-2">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.reports.student-lead-notes') ? 'active' : '' }}"
                    href="{{ route('admin.reports.student-lead-notes') }}">
                    Lead Notes
                </a>
            </li>
            <li class="nav-item">
    ...
    <div class="card-body table-responsive">
        ...
        <form method="GET" class="row mb-3 g-2">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('admin.reports.student-lead-notes') }}" class="btn btn-light">Reset</a>
            </div>
