        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    @if($staff->photo)
                        <img src="{{ asset('storage/' . $staff->photo) }}" class="rounded-circle mb-3" width="120">
                    @endif
    ...
    <div class="modal fade" id="salaryModal">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form method="POST" id="salaryForm" action="{{ route('admin.staffs.salary.store') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="paid_amount" id="paidAmountField" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="payment_date" id="paymentDateField" class="form-control"
                                value="{{ date('Y-m-d') }}">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" type="submit" id="saveSalaryBtn"
    ...
    <div class="modal fade" id="balancePaymentModal">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form method="POST" id="balancePaymentForm" action="{{ route('admin.staffs.salary.pay-balance') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="balanceSalaryMonth" class="form-control" disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" id="balanceSalaryAmount" class="form-control" disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" id="balanceAlreadyPaid" class="form-control" disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" id="balanceDueAmount" class="form-control" disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="payment_amount" id="balancePaymentAmount"
                                class="form-control" required placeholder="Enter amount to pay">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="payment_date" id="balancePaymentDate" class="form-control"
                                value="{{ date('Y-m-d') }}">
