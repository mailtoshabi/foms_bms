...
@section('content')
    ...
    @slot('li_1') Account Settings @endslot
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="new_password_confirmation"
                                        name="new_password_confirmation" placeholder="Enter Your Password">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-wrap gap-2">
                            <button type="submit" class="btn btn-primary waves-effect waves-light"
                                onclick="this.disabled=true; this.innerText='Saving...'; this.form.submit();">Update</button>
