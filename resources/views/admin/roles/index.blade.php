                    ...
                    <tbody>
                        ...
                        @foreach($roles as $role)
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control form-control-sm border-0 role-edit-input"
                                        data-id="{{ encrypt($role->id) }}" value="{{ ucfirst($role->name) }}">
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="text-danger delete-role" data-id="{{ encrypt($role->id) }}"
